...
public class StrLangParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class AtribExprContext extends StatContext {
		public TerminalNode ID() { return getToken(StrLangParser.ID, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public AtribExprContext(StatContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case T__0:
				...
				break;
			case ID:
				_localctx = new AtribExprContext(_localctx);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ContactExprContext extends ExprContext {
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		public ContactExprContext(ExprContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 3:
						{
						_localctx = new ContactExprContext(new ExprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(46);
