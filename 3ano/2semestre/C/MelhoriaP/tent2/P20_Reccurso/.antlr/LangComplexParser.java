...
public class LangComplexParser extends Parser {
	...
	public static final int
		RULE_main = 0, RULE_stat = 1, RULE_expr = 2, RULE_types = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"main", "stat", "expr", "types"
		};
	}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class TypesExprContext extends ExprContext {
		public TypesContext types() {
			return getRuleContext(TypesContext.class,0);
		}
		public TypesExprContext(ExprContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case ID:
				{
				_localctx = new TypesExprContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(36);
				types();
	...
	@SuppressWarnings("CheckReturnValue")
	public static class IdTypeContext extends TypesContext {
		public TerminalNode ID() { return getToken(LangComplexParser.ID, 0); }
		public IdTypeContext(TypesContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class CompTypeContext extends TypesContext {
		public TerminalNode COMP() { return getToken(LangComplexParser.COMP, 0); }
		public CompTypeContext(TypesContext ctx) { copyFrom(ctx); }
	}
	...
	public final TypesContext types() throws RecognitionException {
		...
		try {
			...
			case ID:
				...
				break;
			case COMP:
				_localctx = new CompTypeContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(51);
				match(COMP);
