...
ARCHITECTURE structure OF CntSpecial IS
...
-- Equation(s):
-- \s_count~3_combout\ = (\s_count[0]~0_combout\ & (!\reset~input_o\ & (s_count(0) $ (!s_count(1)))))
...
-- Equation(s):
-- \s_count[0]~2_combout\ = (\reset~input_o\) # (\enable~input_o\)
...
-- Equation(s):
-- \s_count~4_combout\ = (\s_count[0]~0_combout\ & (!\reset~input_o\ & (s_count(2) $ (!\Add0~0_combout\))))
...
-- Equation(s):
-- \s_count~5_combout\ = (!\reset~input_o\ & ((s_count(3) & ((!s_count(2)))) # (!s_count(3) & (!\Add0~0_combout\ & s_count(2)))))
...
-- Equation(s):
-- \s_count[0]~0_combout\ = (s_count(0)) # ((s_count(1)) # ((!s_count(3)) # (!s_count(2))))
...
-- Equation(s):
-- \s_count~1_combout\ = (!s_count(0) & (!\reset~input_o\ & \s_count[0]~0_combout\))
