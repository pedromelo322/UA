...
-- Equation(s):
-- \inst|Add0~0_combout\ = \SW[3]~input_o\ $ (\KEY[0]~input_o\)
...
-- Equation(s):
-- \inst|Add0~1_combout\ = \SW[2]~input_o\ $ (\KEY[0]~input_o\)
...
-- Equation(s):
-- \inst|Add0~2_combout\ = \SW[1]~input_o\ $ (\KEY[0]~input_o\)
...
-- Equation(s):
-- \inst|Add0~3_combout\ = \SW[0]~input_o\ $ (\KEY[0]~input_o\)
...
-- Equation(s):
-- \inst|Add0~12_combout\ = ((\SW[7]~input_o\ $ (\inst|Add0~0_combout\ $ (!\inst|Add0~11\)))) # (GND)
-- \inst|Add0~13\ = CARRY((\SW[7]~input_o\ & ((\inst|Add0~0_combout\) # (!\inst|Add0~11\))) # (!\SW[7]~input_o\ & (\inst|Add0~0_combout\ & !\inst|Add0~11\)))
